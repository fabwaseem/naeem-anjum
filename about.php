...
<html lang="en">
  <head>
    ...
    />
    <title>Naeem Anjum • Freelance Designer & Developer</title>
    <meta name="description" content="" />
    <meta
      property="og:title"
      content="Naeem Anjum • Freelance Designer & Developer"
    />
    <meta property="og:description" content="" />
    <meta property="og:image" content="#" />
    <meta property="og:site_name" content="Naeem Anjum" />
  ...
  <body data-barba="wrapper">
    ...
    >
      ...
      <div class="main-wrap" data-scroll-container>
              ...
              <div class="btn btn-link btn-left-top">
                ...
                >
                  <span class="btn-text">
                    ...
                    <div class="cbd">
                      <span class="dennis"
                        ><span class="dennis-span">Naeem</span>
                        <span class="snellenberg"> Anjum</span></span
                      >
                    </div>
                  </span>
                </a>
        ...
        <section
          class="section no-padding line-globe once-in"
          data-scroll-section
        >
            ...
            <div class="row">
              <div class="flex-col">
                ...
                <p
                  ...
                  data-scroll-offset="0%, -50%"
                >
                  <span style="opacity: 0.5; display: block; padding-top: 0.5em"
                    >Always exploring<span class="animate-dot">.</span
                    ><span class="animate-dot">.</span
                    ><span class="animate-dot">.</span></span
                  >
                </p>
              </div>
              <div class="flex-col">
        ...
        <section class="section about-services" data-scroll-section>
          <div class="container">
            <div class="row">
              <div class="flex-col">
                <h2>
                  I can help you with <span class="animate-dot">.</span
                  ><span class="animate-dot">.</span
                  ><span class="animate-dot">.</span>
                </h2>
              </div>
          ...
          <div class="container medium">
            <div class="row">
              ...
              <div class="flex-col">
                ...
                <p>
                  I am a proud member of the Awwwards International Jury, where
                  I judge the best websites in the world using my expertise as a
                  designer and developer. Micro animations and transitions have
                  my full attention and get me thrilled with every move.
                </p>
              </div>
            </div>
          </div>
        ...
        <div
          class="footer-wrap footer-footer-wrap theme-dark"
          data-scroll-section
        >
          <footer
